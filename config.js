...
// or roles are re-ordered. Confirmed live in the Kaizen group server as of 2026-06-20.
...
module.exports = {
          ROLES: {
                      ...
                      // Path-selection automation (#choose-your-path, decided 2026-06-20) — pre-existing live
                      // roles, not created by the bot. MEMBER = general Kaizen community access (legacy
                      // channels). AI_ACADEMY = legacy flat role that already gates #beginner-help and
                      // #placement-quiz.
                      MEMBER: 'Member',
          ...
          CHANNELS: {
                      ...
                      BOT_LOGS: 'bot-logs',
                      // Matched with .includes() in pathSelect.js, not strict equality, because the live
                      // channel name carries an emoji prefix in some clients ("🧭・choose-your-path").
